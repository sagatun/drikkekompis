    ...
    <div className={className} ref={dropdownRef}>
      ...
      {hasHits && options.length > 0 && isDropdownOpen && (
        <div
          ...
          className="absolute p-2 mt-2 overflow-auto bg-gray-100 rounded shadow-lg right-4"
        >
          {isSearchable && (
            <input
              autoFocus
              className="sticky w-full px-2 py-2 mb-4 text-gray-800 bg-white rounded shadow-md -left-2 -right-2 -top-2 cursor-text "
              value={searchTerm}
